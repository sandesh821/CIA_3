...
#     conv2 = BatchNormalization()(conv2)
    ...
    lstm1 = LSTM(40, activation='relu', return_sequences=True,recurrent_dropout=0.4,dropout=0.4)(conv1)
...
#     output = Dense(1)(hidden1)
    ...
    ##Decoder
    #repeat1 = RepeatVector(n_outputs)(merge)
    lstm2 = LSTM(4, activation='relu', return_sequences=True)(merge)
